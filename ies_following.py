...
def following(iesGraph,followerMMSI, followedMMSI, startTimeStamp, endTimeStamp,inferenceSystem):
    ...
    ies.addToGraph(iesGraph=iesGraph,subject=folrPart,predicate=ies.ipi,obj=fol)
    ...
    if (inferenceSystem):
        ...
        ies.putInPeriod(iesGraph=iesGraph,item=assessment,timeString="2007-01-02T09:17:04")
